...
console.log("Olá! O Node está a funcionar.");const parte1 = "Node";
const parte2 = ".js";
// Guardamos o resultado da junção em uma terceira variável antes de imprimir
const resultado = parte1 + parte2;
console.log(resultado);// '__filename' é uma variável especial que guarda o caminho completo deste arquivo no disco
